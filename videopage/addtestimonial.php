...
if (isset($_POST['btnSave'])) {
  ...
  if (!isset($errorMsg)) {
    $sql = "insert into client(clientImage, clientName, location, testimonial)
              values('" . $userPic . "','" . $clientname . "','" . $location . "','" . $testimonial . "')";
            ...
            <div class="card-body">
              ...
              <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="clientname" class="form-control" id="" placeholder="ClientName">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="testimonial" class="form-control" id="" placeholder="Description">
                </div>
